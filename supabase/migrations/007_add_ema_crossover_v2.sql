-- Add EMA Crossover V2 indicator seed (EMA cross + ADX filter)
-- Keeps existing ema_crossover intact and introduces filtered variant.

INSERT INTO indicators (name, config, is_active)
VALUES (
  'ema_crossover_v2',
  '{"fast_period": 9, "slow_period": 21, "adx_period": 14, "adx_threshold": 20, "enable_adx_filter": 1}',
  false
)
